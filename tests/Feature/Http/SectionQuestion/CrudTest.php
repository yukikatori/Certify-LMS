...
class CrudTest extends TestCase
{
    ...
    public function test_admin_can_update_replaces_options_via_delete_and_insert(): void
    {
        $admin = User::factory()->admin()->create();
        $cert = Certification::factory()->published()->create();
        [, , $section] = $this->makePartChain($cert);
    ...
    public function test_admin_can_publish_requires_valid_options(): void
    {
        $admin = User::factory()->admin()->create();
        $cert = Certification::factory()->published()->create();
        [, , $section] = $this->makePartChain($cert);
    ...
    public function test_admin_can_destroy_soft_deletes_section_question(): void
    {
        $admin = User::factory()->admin()->create();
        $cert = Certification::factory()->published()->create();
        [, , $section] = $this->makePartChain($cert);
    ...
    public function test_coach_can_create_section_question_with_options(): void
    {
        $admin = User::factory()->admin()->create();
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
    ...
    public function test_coach_can_update_replaces_options_via_delete_and_insert(): void
    {
        $admin = User::factory()->admin()->create();
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
    ...
    public function test_coach_can_publish_requires_valid_options(): void
    {
        $admin = User::factory()->admin()->create();
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
    ...
    public function test_assigned_coach_can_view_section_questions(): void
    {
        $admin = User::factory()->admin()->create();
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
    ...
    public function test_coach_can_destroy_soft_deletes_section_question(): void
    {
        $admin = User::factory()->admin()->create();
        $coach = User::factory()->coach()->create();
        $cert = Certification::factory()->published()->create();
